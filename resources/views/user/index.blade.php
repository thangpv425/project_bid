		...
		<div class="row">
			<div class="col-sm-3">
				<ul class="user-page-menu">
					...
					<li class="user-page-menu-item"><a href="{{route('user.change-email')}}">Đổi email</a></li>
					<li class="user-page-menu-item"><a href="{{route('user.change-password')}}">Đổi mật khẩu</a></li>
					<li class="user-page-menu-item"><a href="{{route('user.inactive')}}">Xóa tài khoản</a></li>
